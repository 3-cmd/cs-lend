...
public class LendController {
    ...
    @GetMapping("/list")
    public R list() {
        Page<Lend> page = lendService.getByPageList(null, null, null);
        return R.success().add("lendList", page.getRecords());
    }
    @ApiOperation("获取标的信息")
    @GetMapping("/show/{id}")
    public R show(
        ...
        return R.success().add("lendDetail", lendDetail);
    }
    @ApiOperation("计算投资收益")
    ...
    public R getInterestCount(
        ...
        return R.success().add("interestCount", interestCount);
    }
}
